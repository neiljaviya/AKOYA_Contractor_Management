...
import { Calendar, Clock, Building2, User, Plus, ChevronLeft, ChevronRight, X } from 'lucide-react';
...
const ContractorScheduler = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('contractorSchedules');
    if (saved) {
  ...
  useEffect(() => {
    localStorage.setItem('contractorSchedules', JSON.stringify(schedules));
  }, [schedules]);
